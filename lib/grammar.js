function Grammar(Parser, lexer, names, behaviour) {
    ...
    g.stmt(n.PUT, function () { return b.putStone(parenthesisExpression()); });
    g.stmt(n.REMOVE, function () { return b.removeStone(parenthesisExpression()); });
    g.stmt(n.MOVE, function () { return b.moveClaw(parenthesisExpression()); });
    g.prefix(n.HAS_STONES, function () { return b.hasStone(parenthesisExpression());  });
    g.prefix(n.CAN_MOVE, function () { return b.canMove(parenthesisExpression());  });
    ...
    g.stmt(n.PROCEDURE, function(){
        ...
        return b.procedureDeclaration(name, parameters, body);
    });
